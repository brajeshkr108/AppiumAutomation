...
public class RegisterUserTest extends BrowserInitializer {
	...
	public void loginApp(Hashtable<String, String> tabledata) throws IOException  {
		...
		try{
			...
			Generic.takeScreenShot();
			initializer.logger.log(LogStatus.INFO, "Screenshots",initializer.logger.addScreenCapture(initializer.screenShotFilename));
			...
			resultFlag = "fail";
			initializer.logger.log(LogStatus.FAIL, "Test Script failed due to Exception");
